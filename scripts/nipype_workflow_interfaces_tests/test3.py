...
from nipype.interfaces.base.traits_extension import Directory, BasePath, File, Undefined, Str
import os
...
pipeline = Workflow(name='multiout_test_zzzzz',
                    base_dir='/tests/scripts/nipype_scripts')
...
iterate_node2.inputs.track_path = '/tests/pipeline_tests/track_warp_nipype_testing/convertwarp_test_final/tck2mni/tck2mni_tracks.trk'
