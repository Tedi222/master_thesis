...
if __name__ == '__main__':
    ...
    # pipeline
    pipeline = Workflow(name='sift_test3', base_dir='/home/teodorps/tests/pipeline_tests')
    ...
    templates = {'wm_odf': 'dwi2fod_3tt/wm.mif',
                 'tracks': 'tckgen/tracked.tck'}
  ...
  # datasink for final storage
    ...
    # connect filtering 
    pipeline.connect([
        (sf, tckcompress, [('tracks', 'in_file')])
        ])

    pipeline.connect([
        (sf, tcksift, [('wm_odf' , 'in_fod')]),
